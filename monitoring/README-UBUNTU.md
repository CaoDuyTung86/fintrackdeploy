...
Hướng dẫn triển khai hệ thống monitoring FinTrack trên Ubuntu 24.04.1 với 3 phương pháp khác nhau.
...
## 🐧 Phương pháp 2: Native Installation (Production)
...
## ☸️ Phương pháp 3: Kubernetes (Enterprise)
...
```bash
# Cấp quyền thực thi
chmod +x k8s-deploy.sh k8s-stop.sh
...
# Xem logs
kubectl logs -n fintrack deployment/fintrack-backend
kubectl logs -n fintrack deployment/prometheus
kubectl logs -n fintrack deployment/grafana
```
